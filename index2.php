...
<head>
  ...
  <title>recipe sample site2</title>
...
<!--main部分-->
    ...
    <div class="main-wrapper">
        ...
        <h4>料理名</h4>
        <input type="text" name="recipe_name" size="80">
        <div class="recepi_food">
        <h4>材料</h4>
        <textarea name="foodstuff" rows="10" cols="80"></textarea>
        
        <h4>手順</h4>
        <textarea name="foodorder" rows="10" cols="80"></textarea>
        </div>
            
        <input type="submit" value="レシピ提出">    
        </form>
        </div>
    </div>
    </div>
